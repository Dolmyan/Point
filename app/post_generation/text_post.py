...
async def choose_text_type(callback_query: CallbackQuery, state: FSMContext):
    ...
    content = f"""
            ...
            3. Начало обязано цеплять (хук). Текст — логичный ввод → развитие → вывод/инсайт.
            4. Дай практическую ценность: 1–3 конкретных совета/факта/преимущества.
            5. Заканчивай лёгким CTA (вопрос, действие, контакт).
            6. НЕ добавляй ничего сверх: никаких пояснений, дополнительных вариантов, инструкций или примечаний. Только сам пост.
            7. Если стиль пустой или содержит «[без подписи]» — используй нейтральный экспертный тон, кратко и уверенно.
            
            Выведи только результат — готовый текст поста, без кавычек, без объяснений.
            """
