...
async def choose_text_type(callback_query: CallbackQuery, state: FSMContext):
    ...
    — Если формат = "text_hooks":  
       ...
       Шаблон генерации хуков:

Тема (курсивом)
«Веб-дизайн: актуальные тренды» (жирным)
- - - - - - - - - - - - - - - - - - 

Провокационные / Спорные
1. 
2. 
3. 

Распространенная Ошибка / Негативный Угол
1. 
2. 
3. 

Сторителлинг (Личный Опыт / Путь Автора)
1. 
2. 
3. 
...
Ориентированные на Выгоду / Ценность
1. 
2. 
3. 

Разрыв Любопытства / Тизер
1. 
2. 
3. 

Узнаваемая Ситуация / Боль
1. 
2. 
3. 

Удивительная Статистика / Факт
1. 
2. 
3. 
...
- - - - - - - - - - - - - - - - - - 
    ...
    — Если формат = "text_threads":  
       Сначала выведи тему отдельной строкой. , ее сделай жирной с помощью тега b 
       Затем через разделитель («- - - - - - - -») оформи развернутую нить, каждую нить пиши через разделитель: несколько коротких абзацев (3–6), где каждый абзац — отдельная мысль или часть аргументации. Отделяй разделителем каждый абзац.
       ...
       Структура должна напоминать ленту «твитов/тредов», как в примере threads.
         - Всё оформляй **как цитату Telegram**, без лишних пояснений

Шаблон генерации треда:

<b>Тема</b>
«Веб-дизайн: актуальные тренды»
- - - - - - - - - - - - - - - - - - 

> Абзац 1 — вводная мысль / факт
- - - - - - - - - - - - - - - - - - 

> Абзац 2 — развитие аргумента / пример
- - - - - - - - - - - - - - - - - - 

> Абзац 3 — конкретные советы / список
→ пункт 1
→ пункт 2
→ пункт 3
- - - - - - - - - - - - - - - - - - 

> Абзац 4 — дополнительные наблюдения / советы
- - - - - - - - - - - - - - - - - - 

> Абзац 5 — сильный вывод / правило + лёгкий CTA
- - - - - - - - - - - - - - - - - - 
